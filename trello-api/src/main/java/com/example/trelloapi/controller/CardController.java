...
public class CardController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<CardDto> updateCard(@PathVariable UUID id, @Valid @RequestBody TitleRequest request) {
    ...
    public ResponseEntity<CardDto> moveCard(@PathVariable UUID id, @Valid @RequestBody MoveCardRequest request) {
